...
master | TEST
:------------: | :------------:
[![master Build Status](https://travis-ci.com/shamage/TrinityCore-singleCore.svg?token=U8SkayzfbAvhS4ECSQky&branch=main)](https://travis-ci.com/shamage/TrinityCore-singleCore.svg?token=U8SkayzfbAvhS4ECSQky&branch=main) |
