...
(8899, 0, 0, "Please loan me that spyglass.", 22806, 1, 1, 0),
(8886, 0, 0, "Sergeant, loan me your spyglass.", 22774, 1, 1, 0);

DELETE FROM `gossip_menu_option_action` WHERE `MenuID` IN (8899, 8886);
